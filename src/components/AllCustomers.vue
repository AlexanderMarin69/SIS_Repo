<template>
    <div class="pl-1 pr-1">
        <v-card max-width="1000" raised shaped
            ...
            <v-toolbar 
                       light>
                <v-toolbar-title color="black">Alla kunder</v-toolbar-title>
                <v-spacer></v-spacer>
                <!--<v-btn icon class="ml-3 mr-3">
                    <v-icon>mdi-magnify</v-icon>
                    sök
                </v-btn>-->
                <v-btn color="primary" rounded  style="color: white;" @click="addNewCustomerDialog = !addNewCustomerDialog" class="ml-3">
                    Skapa ny +
                </v-btn>
            </v-toolbar>
            ...
            <v-dialog v-model="addNewCustomerDialog" persistent max-width="1000px">
                <v-card>
                    ...
                    <v-card-text>
                        <v-container>
                            <v-row>
                                ...
                                <v-col cols="12" sm="6" md="4">
                                    <v-text-field v-model="customerId" label="Kundnummer" required></v-text-field>
                    ...
                    <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn color="blue darken-1" text @click="closeDialog">Stäng</v-btn>
                        <v-btn color="blue darken-1" v-if="customerId" text @click="createNewCustomer()">Skapa</v-btn>
                        <v-btn color="blue darken-1" v-else text disabled @click="createNewCustomer()">Skapa</v-btn>
                    </v-card-actions>
                </v-card>
            </v-dialog>
        </v-row>
